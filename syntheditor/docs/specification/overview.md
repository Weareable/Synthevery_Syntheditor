...
Syntheveryは、各デバイスが8つのトラックを持ち、各トラックには個別に楽器やシーケンサーを割り当てることができます。
また、各デバイスは「手持ち」「左右の手足」など柔軟なPosition（装着位置）を持ち、Position情報をもとに演奏モードやモーション検知方法を自律的に切り替えます。
これにより、複数デバイスによる多様な演奏スタイルや、デバイス配置に応じた高度な連携が可能です。
